      ...
      builder: (context, constraints) {
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            actions: [
              TextButton.icon(
                onPressed: controller.entries.isEmpty ? null : controller.clearLogs,
...
class _MobileLayout extends StatelessWidget {
  const _MobileLayout({required this.controller, required this.horizontalPadding, required this.topPadding});
    ...
    return [
      for (var index = 0; index < controller.examples.length; index++) ...[
        _ExampleCard(
          ...
          isBusy: controller.isBusy,
          isRunning: controller.activeExampleId == controller.examples[index].id,
      ...
      child: hasLogs
          ? SingleChildScrollView(
              child: SelectableText(
                ...
                style: const TextStyle(color: Color(0xFFE5E7EB), height: 1.5, fontSize: 13, fontFamily: 'monospace'),
              ),
            )
          : Center(
              child: Text(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: const Color(0xFF9CA3AF)),
            ),
...
class _ExampleCard extends StatelessWidget {
  const _ExampleCard({required this.example, required this.isBusy, required this.isRunning, required this.onRun});
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            if (isCompact) ...[
              Text(example.title, style: theme.textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w700)),
              const SizedBox(height: 8),
              Text(
                example.description,
                style: theme.textTheme.bodyMedium?.copyWith(color: const Color(0xFF475569), height: 1.45),
              ),
